"""
Django settings for tetst_38403 project.
...
WSGI_APPLICATION = 'tetst_38403.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tetst_38403 API",
    "DESCRIPTION": "API documentation for tetst_38403 App",
    "VERSION": "v1",
}
